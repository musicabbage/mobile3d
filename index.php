...
<head>
  ...
  <link rel="stylesheet" href="../lab1/assets/css/custom.css">
  <script src="https://cdn.jsdelivr.net/npm/jquery@3.6.3/dist/jquery.slim.min.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>

  <!-- our project just needs Font Awesome Solid + Brands -->
  <link rel="stylesheet" href="../lab1/assets/fontawesome/css/all.css">
  <link rel="stylesheet" href="../lab1/assets/fontawesome/css/solid.css">
  <link rel="stylesheet" href="../lab1/assets/fontawesome/css/fontawesome.css">
  <!-- fonts -->
  ...
  <div class="container main_container">
    ...
    <div class="row">
      <div class="col-sm-4">
        <div class="card">
          <a href="#">
            <img src="../lab1/assets/images/coca_cola.jpg" class="card-img-top img-fluid img-thumbnail" alt="Coca Cola">
          </a>
          <div class="card-body">
      ...
      <div class="col-sm-4">
        <div class="card">
          <a href="#">
            <img src="../lab1/assets/images/sprite.jpg" class="card-img-top img-fluid img-thumbnail" alt="Sprite">
          </a>
          <div class="card-body">
      ...
      <div class="col-sm-4">
        <div class="card">
          <a href="#">
            <img src="../lab1/assets/images/dr_pepper.jpg" class="card-img-top img-fluid img-thumbnail" alt="Dr Pepper">
          </a>
          <div class="card-body">
